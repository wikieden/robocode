...
从 [Viden v0.1.30](https://github.com/wikieden/viden/releases/tag/v0.1.30)
下载 release 压缩包。
...
Viden 会读取平台默认配置路径，然后读取 `.viden/config.toml`，CLI flags 优先级最高。
...
请通过 [GitHub Issues](https://github.com/wikieden/viden/issues)
反馈 bug 和功能建议。
