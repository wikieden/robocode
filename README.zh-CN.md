...
从 [RoboCode v0.1.4](https://github.com/wikieden/robocode/releases/tag/v0.1.4)
下载 release 压缩包。
...
- `/test <command>` 会走和 agent tool call 相同的 shell 审批路径，并把最近一次测试的状态、exit code、耗时、命令和输出尾部记录到 `/status`。
...
- [0.1.4 发布状态](docs/release-0.1.4-status.zh-CN.md)
- [0.1.5 计划](docs/release-0.1.5-plan.zh-CN.md)
