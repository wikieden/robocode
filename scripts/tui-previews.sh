...
assert_contains "$OUT_DIR/main-command-palette.txt" "› /git worktree remove /tmp/robocode/.worktrees/"
assert_contains "$OUT_DIR/main-command-palette.txt" "Branch codex/tui-cockpit"
