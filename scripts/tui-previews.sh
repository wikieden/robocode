...
assert_contains "$OUT_DIR/main-command-palette.txt" "SELECT MODEL"
assert_contains "$OUT_DIR/main-command-palette.txt" "Search deep"
assert_contains "$OUT_DIR/main-command-palette.txt" "deepseek-v4-flash"
...
assert_ansi_contains "$OUT_DIR/main-command-palette.ansi" "SELECT MODEL"
