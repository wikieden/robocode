...
assert_contains "$OUT_DIR/main-live-turn.txt" "is planning"
...
assert_contains "$OUT_DIR/main.txt" "✦"
assert_contains "$OUT_DIR/main.txt" "Supervising"
assert_contains "$OUT_DIR/main-resize.txt" "✦"
...
assert_ansi_contains "$OUT_DIR/main-live-turn.ansi" "is planning"
