...
require_text docs/release-0.1.24-plan.md "scripts/tdd-testing-contract-smoke.sh"
require_text docs/release-0.1.24-plan.zh-CN.md "scripts/tdd-testing-contract-smoke.sh"
require_text docs/spec-review-0.1.24.md "TDD testing contract smoke"
require_text docs/spec-review-0.1.24.zh-CN.md "TDD testing contract smoke"
