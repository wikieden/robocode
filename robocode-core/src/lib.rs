...
use robocode_types::{
    ...
    ModelEvent, ModelRequest, PermissionDecision, PermissionLogEntry, PermissionMode,
    ResumeContextSnapshot, Role, RuntimeSnapshot, SessionMetaEntry, SessionSummary, TaskPriority,
    TaskStatus, ToolCall, ToolInput, ToolResult, ToolSpec, TranscriptEntry, fresh_id,
    now_timestamp,
};
