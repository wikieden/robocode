...
- Design source: `docs/viden-design/Viden/GUI/`, including
  `gui-icons.jsx`, `gui-kit.css`, and the accepted D1 dark cockpit capture.
...
The accepted source capture is 5140 by 2650 pixels at 144 DPI. The browser
implementation was captured at 2570 by 1325 CSS pixels and normalized at 2x to
5140 by 2650 before comparison. This preserves the source capture's effective
device scale without changing the implementation's layout proportions.
...
- Accessibility: the shell regions have stable landmarks and labels. The
  ...
  Enter, reports `aria-expanded`, and receives focus.
