...
//! runtime surface from `viden-core` and must not own provider, tool, or
//! workflow business logic.

mod tui;

pub use tui::{
    SideScreen, is_known_theme, render_ansi_cjk_input_preview_with_theme,
    ...
    render_setup_wizard_preview, render_side_preview, run_side_tui_with_theme, run_tui_with_theme,
    theme_names,
};
