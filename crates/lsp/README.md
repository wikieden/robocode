...
- `viden-types` for serializable semantic result contracts.
...
- Semantic result types remain owned by `viden-types` so future MCP, plugin, and agent flows can reuse them.
