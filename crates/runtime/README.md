...
`viden-runtime` owns `SessionEngine`: the shared runtime path for user input, slash commands, provider events, tool calls, permission checks, transcript writes, and workflow commands.
