# Viden 0.1.19 Status - Delegated Lane Usefulness
...
- Local package: `dist/viden-v0.1.19-aarch64-apple-darwin.tar.gz`
...
Result: passed at `/tmp/viden-0119-postpublish-check`, including GitHub
...
Result: `brew fetch` resolved formula `viden (0.1.19)` and audit produced no
errors.
