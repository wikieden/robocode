...
(function(){
  ...
  function mount(){
    ...
    s.textContent='#vlang{position:fixed;top:12px;right:12px;z-index:99999;display:flex;gap:2px;background:rgba(10,16,25,.92);border:1px solid #173a4d;border-radius:9px;padding:3px;font-family:ui-monospace,SFMono-Regular,monospace;backdrop-filter:blur(5px);box-shadow:0 6px 20px rgba(0,0,0,.4)}#vlang button{border:0;background:transparent;color:#5a7384;font-size:12px;font-weight:700;padding:4px 11px;border-radius:6px;cursor:pointer;line-height:1}#vlang button.on{background:#143049;color:#74e4f2}#vlang button:hover{color:#8aa9bf}';
